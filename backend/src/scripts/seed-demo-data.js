  ...
  return [
    {
      ...
      endDate: new Date(now.getTime() + 3 * 24 * 60 * 60 * 1000 + 8.5 * 60 * 60 * 1000),
      ...
      agenda: [
        ...
        },
        {
          ...
          description: 'Teams demo products across accessibility and campus life.',
        },
      ],
      status: 'published',
      createdBy: adminId,
    ...
    },
    {
      ...
      endDate: new Date(now.getTime() + 1 * 24 * 60 * 60 * 1000 + 4.5 * 60 * 60 * 1000),
      venue: 'Eco Courtyard',
      mode: 'In Person',
      capacity: 200,
      registeredCount: 0,
    ...
    },
    {
      ...
      endDate: new Date(now.getTime() - 2 * 24 * 60 * 60 * 1000 + 7 * 60 * 60 * 1000),
